...
public final class Constants {
	...
	public static final class ArmConstants {
		...
		public static final double[] kHighOffsets = { 12, 3.5 };
		public static final double[] kMediumOffsets = { 10, 1.5 };
		public static final double[] kLowOffsets = { 9, 0 };
		...
		public static final double kP = 0.01; // 0.005 will not smash encoders
