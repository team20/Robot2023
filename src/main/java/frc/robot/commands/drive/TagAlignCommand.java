...
public class TagAlignCommand extends CommandBase {
  ...
  private double m_driveSpeed = 0.35 * .5;  //constant
  ...
  private double getTurn(Pose2d goalPoint, Pose2d currPoint) {
    ...
    SmartDashboard.putNumber("Goal Angle", vectorAngle);
    SmartDashboard.putNumber("Goal Distance", Math.sqrt(distanceSquared));
