...
public class PoseEstimationSubsystem extends SubsystemBase {
	...
	/**
	 * The single {@code RobotPoseEstimator} instance.
	 */
	static PoseEstimationSubsystem s_subsystem;
	...
	/**
	 * Returns the single {@code PoseEstimationSubsystem} instance.
	 * @return the single {@code PoseEstimationSubsystem} instance
	 */
	...
	/**
	 * Determines whether or not the specified {@code Pose} is safe to use.
	 * @param poseDetected a {@code Pose} detected
	 * @param poseEstimator a {@code RobotPoseEstimator}
	 * @return {@code true} if the specified {@code Pose} is safe to use; {@code false} otherwise
	 */
